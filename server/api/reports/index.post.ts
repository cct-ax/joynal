...
defineRouteMeta({
  openAPI: {
    tags: ['reports'],
    summary: '日報作成',
    description: '新人のみ作成できる（RLS で強制）。check_out > check_in（Zod .refine で検証、JSON Schema には現れない）。同じ日付の日報が既にある場合は 409。',
    requestBody: {
      required: true,
    ...
    responses: {
      201: { description: '作成された日報', content: { 'application/json': { example: { id: 'uuid', user_id: 'uuid', date: '2026-05-19', check_in: '09:00:00', check_out: '18:00:00', content: 'やったことの本文', mood: 4, created_at: '2026-05-19T09:00:00Z', updated_at: '2026-05-19T09:00:00Z' } } } },
